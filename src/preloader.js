...
BasicGame.Preloader.prototype = {
    ...
    this.load.image('menuScreen', 'assets/img/menu.png');
    this.load.image('preLevelScreen', 'assets/img/prelevel.png');
    this.load.image('levelScreen', 'assets/img/level.png');
    this.load.image('killButton', 'assets/img/kill.png');
    this.load.image('carnageButton', 'assets/img/carnage.png');
    this.load.spritesheet('bloodNumbers', "assets/img/numbers.png", 6, 9);
    this.load.spritesheet('carButtons', 'assets/img/car-buttons.png', 34, 11);
    this.load.spritesheet('truckButtons', 'assets/img/truck-buttons.png', 48, 20);
    this.load.spritesheet('bikeButtons', 'assets/img/bike-buttons.png', 21, 11);
    this.load.image('carUnit', 'assets/img/car.png');
    this.load.image('truckUnit', 'assets/img/truck.png');
    this.load.image('bikeUnit', 'assets/img/bike.png');
    this.load.spritesheet('endTurnButton', 'assets/img/end-turn.png', 40, 10);
    this.load.image('barbwireEnemy', 'assets/img/barbwire.png');
    this.load.image('raiderEnemy', 'assets/img/raider.png');
    this.load.image('watchtowerEnemy', 'assets/img/watchtower.png');
    this.load.image('bunkerEnemy', 'assets/img/bunker.png');
    this.load.image('crosshair', 'assets/img/crosshair.png');
    this.load.spritesheet('tiles', 'assets/img/tiles.png', 16, 16);
    ...
    this.load.image('health', 'assets/img/health.png');
		...
		this.load.image('nextLevel', 'assets/img/next-level.png');
